        ...
        {!paymentSuccess ? (
          ...
          >
            <motion.div
              ...
              className="absolute w-32 h-44 md:w-40 md:h-52 drop-shadow-md z-10"
            >
              <Image
                src="/bride.png"
                alt="Bride"
            ...
            <motion.div
              animate={{ x: groomX }}
              transition={{ type: "spring", stiffness: 40, damping: 12 }}
              className="absolute w-32 h-44 md:w-40 md:h-52 drop-shadow-md z-0"
            >
              <Image
                src="/groom.png"
                alt="Groom"
            ...
            <motion.p
              ...
              className="absolute bottom-0 text-[9px] uppercase tracking-widest text-[#8c363e] font-bold"
            >
          ...
          >
            <motion.div
              ...
              className="absolute w-64 h-64 bg-gradient-to-tr from-[#8c363e]/20 to-yellow-300/20 rounded-full blur-2xl z-0"
            />
            <div className="relative w-44 h-44 md:w-56 md:h-56 drop-shadow-2xl z-10">
              <Image
                src="/step-3.png"
                alt="Forever Begins Now"
                fill
                className="object-contain"
                priority
              />
              <div className="absolute inset-0 pointer-events-none">
                ...
                <motion.div
                  animate={{ y: [0, -60, 30], opacity: [0, 1, 0] }}
                ...
                <motion.div
                  ...
                  className="absolute bottom-0 left-1/4 w-1.5 h-3 bg-yellow-400 rounded-sm"
                />
                <motion.div
                  animate={{
                    y: [100, -100],
                  ...
                  className="absolute bottom-0 right-1/4 w-2 h-2 bg-yellow-500 rounded-full"
                />
              </div>
            </div>
            <motion.div
...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    if (authSession?.user) {
      setSession((prev) => ({
        ...prev,
        uid: (authSession.user as any).id,
  ...
  if (items.length === 0 && !paymentSuccess) {
    return (
      <div className="w-full min-h-screen bg-[#FDF6F5] flex flex-col items-center justify-center pt-24 px-6 text-center">
        <h2 className="font-serif text-3xl text-[#2d1b1b] mb-4">
          Your collection is empty
        </h2>
        <p className="text-sm text-[#C0858B] uppercase tracking-widest mb-8">
          Add a cinematic look before checking out
        </p>
        <Link
          href="/"
          className="bg-[#5A2A2F] text-white px-8 py-3.5 rounded-xl text-[10px] uppercase tracking-widest font-bold hover:bg-[#2d1b1b] transition-colors shadow-lg"
        >
          Return to Studio
        </Link>
      </div>
        ...
        <AnimatePresence mode="wait">
          {paymentSuccess ? (
            ...
            >
              ...
              <h1 className="font-serif text-4xl md:text-5xl text-[#8c363e] mb-4 tracking-tight">
                A Beautiful Journey Begins
              </h1>
              <div className="space-y-4 mb-10 text-gray-600 max-w-xl mx-auto">
                <p className="text-sm md:text-base leading-relaxed font-bold text-[#2d1b1b]">
                  Payment Completed! Your spectacular wardrobe is officially on
                  its way.
                </p>
              ...
              <Link
                href="/"
                className="bg-[#5A2A2F] text-white px-10 py-4 rounded-full text-[10px] uppercase tracking-[0.2em] font-bold hover:bg-[#2d1b1b] transition-all shadow-xl"
              >
                Return to Gallery
              </Link>
            </motion.div>
            ...
            >
              <div className="mb-8">
                <Link
                  href="/"
                  className="inline-flex items-center gap-2 text-xs text-[#C0858B] hover:text-[#8c363e] transition-colors mb-4 uppercase tracking-widest font-bold"
                >
                ...
                <div className="flex items-center gap-4 mt-6">
                  <div
                    className={`flex items-center gap-2 text-[10px] uppercase tracking-widest font-bold ${
                      step >= 1 ? "text-[#8c363e]" : "text-[#C0858B]/50"
                    }`}
                  >
                  ...
                  <div
                    className={`flex items-center gap-2 text-[10px] uppercase tracking-widest font-bold ${
                      step >= 2 ? "text-[#8c363e]" : "text-[#C0858B]/50"
                    }`}
                  >
                    <span className="w-5 h-5 rounded-full border border-current flex items-center justify-center">
                      2
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                <div className="lg:col-span-7 flex flex-col gap-4">
                      ...
                      {step === 1 && (
                        ...
                        >
                          ...
                          <div className="flex items-center my-4">
                            ...
                            <span className="px-3 text-[10px] text-[#C0858B] uppercase tracking-widest font-bold">
                              or
                            </span>
                            <div className="flex-1 border-t border-[#E8D0D2]"></div>
                          </div>
                        ...
                        >
                          <div className="flex items-center justify-between border-b border-[#E8D0D2]/50 pb-4 mb-4">
                            ...
                            <button
                              type="button"
                              onClick={() => setStep(1)}
                              className="text-[10px] uppercase tracking-widest text-[#8c363e] font-bold"
                            >
                              Change
                            </button>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="flex flex-col gap-2">
                              ...
                              <input
                                ...
                                className="w-full bg-[#FCFBF9] border border-[#E8D0D2] rounded-xl px-4 py-3.5 text-sm focus:outline-none focus:border-[#8c363e] transition-colors"
                            ...
                            <div className="flex flex-col gap-2">
                              ...
                              <div className="relative flex items-center">
                                <span className="absolute left-4 text-sm text-[#2d1b1b] font-bold">
                                  +91
                                </span>
                                <input
                                  required
                                  ...
                                  className="w-full bg-[#FCFBF9] border border-[#E8D0D2] rounded-xl pl-12 pr-4 py-3.5 text-sm focus:outline-none focus:border-[#8c363e] transition-colors"
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            <input
                              ...
                              className="w-full bg-[#FCFBF9] border border-[#E8D0D2] rounded-xl px-4 py-3.5 text-sm focus:outline-none focus:border-[#8c363e] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            <textarea
                              ...
                              className="w-full bg-[#FCFBF9] border border-[#E8D0D2] rounded-xl px-4 py-3.5 text-sm focus:outline-none focus:border-[#8c363e] transition-colors resize-none"
                          ...
                          <button
                            type="submit"
                            disabled={loading}
                            className="w-full flex items-center justify-center gap-2 bg-[#5A2A2F] text-white py-4 rounded-xl text-[10px] uppercase tracking-widest font-bold hover:bg-[#2d1b1b] transition-all shadow-lg mt-4"
                          >
                            <CreditCard size={14} />{" "}
                            {loading
                  ...
                  <div className="flex items-center gap-2 text-[10px] text-[#C0858B] uppercase tracking-widest justify-center pt-2">
                    <ShieldCheck size={14} className="text-[#8c363e]" /> 256-bit
                ...
                <div className="lg:col-span-5 lg:sticky lg:top-32 h-fit bg-white border border-[#E8D0D2]/60 rounded-2xl p-6 shadow-[0_10px_40px_rgba(140,54,62,0.03)]">
                  <h3 className="font-serif text-2xl mb-6 pb-4 border-b border-[#E8D0D2]/40">
                    Order Summary
                  </h3>
                    ...
                    {items.map((item) => (
                      ...
                      >
                        <div className="flex gap-3 items-center">
                          ...
                          <div>
                            <h4 className="font-serif text-sm leading-tight text-[#2d1b1b] line-clamp-1">
                              {item.name}
                            </h4>
                            <p className="text-[10px] text-[#C0858B] mt-1">
                              Qty:{" "}
                        ...
                        <p className="text-xs font-bold text-[#5A2A2F]">
                          ₹
                  ...
                  <div className="mt-8 pt-6 border-t border-[#E8D0D2]/40 space-y-3">
                    <div className="flex justify-between text-xs">
                      <span className="text-[#C0858B] uppercase tracking-wider">
                        Subtotal
                      </span>
                    ...
                    <div className="flex justify-between items-end pt-4 border-t border-[#E8D0D2]/40">
                      ...
                      <span className="font-serif text-2xl text-[#8c363e]">
                        ₹{subtotal.toLocaleString("en-IN")}
                      </span>
                    </div>
                  </div>
